...
namespace Farmizo.Web.Shopping.HttpAggregator.Config
{
    public class UrlsConfig
    {
        ...
        public class CatalogOperations
        {
            ...
            public static string GetItemsById(IEnumerable<int> ids) => $":7000/api/v1/catalog/items?ids={string.Join(',', ids)}";
        }

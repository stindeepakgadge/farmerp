...
- Catalog service: http://localhost:7101
- Orders service: http://localhost:7102
- Basket service: http://localhost:7103
- Identity service: http://localhost:7105
- Orders data (SQL Server): Server=tcp:localhost,5432;Database=Farmizo.Services.OrderingDb;User Id=sa;Password=Pass@word;
- Catalog data (SQL Server): Server=tcp:localhost,5434;Database=CatalogDB;User Id=sa;Password=Pass@word
- Identity data (SQL Server): Server=localhost,5433;Database=aspnet-Farmizo;User Id=sa;Password=Pass@word
